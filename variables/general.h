...
// OUTPUT
#define GRADZ_CNT_N_ofst			(17)
#define GRADZ_CNT_P_ofst			(16)
#define GRADZ_3P3_N_ofst			(15)
#define GRADZ_3P3_P_ofst			(14)
...
#define GRADZ_3P3_N			(1<<GRADZ_3P3_N_ofst)
#define GRADZ_3P3_P			(1<<GRADZ_3P3_P_ofst)
...
#define CNT_OUT_DEFAULT (DAC_GRAD_CLR_msk | DAC_GRAD_LDAC_msk | ADC_AD9276_PWDN_msk | ADC_AD9276_STBY_msk | GRADZ_3P3_P | GRADZ_3P3_N)
