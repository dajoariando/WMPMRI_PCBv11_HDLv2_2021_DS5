...
#define EXEC_BSTREAM_PRECHRG_N_RF_N_DUMP
#ifdef EXEC_BSTREAM_PRECHRG_N_RF_N_DUMP
...
int main(int argc, char * argv[]) {
	...
	// test rf output
	bstream__prechrg_n_rf_n_dump(RF_mode, BSTREAM_CLK_IN, RFCLK, dtcl, ind_pchg_us, tx_coil_pchg_us, dump_len_us, en_pchrg, repetition);
